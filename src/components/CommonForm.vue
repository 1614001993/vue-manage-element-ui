<template>
  <el-form :inline="inline" :model="form" label-width="100px" ref="form">
    <el-form-item v-for="item in formLable" :key="item.model" :label="item.label">
      ...
      <el-date-picker v-model="form[item.model]" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" v-if="item.type === 'date'"> </el-date-picker>
    </el-form-item>
    <el-form-item>
      <slot></slot>
    </el-form-item>
